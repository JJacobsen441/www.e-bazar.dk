...
namespace www.e_bazar.dk.Interfaces
{
    public interface IBoothItem 
    {
        ...
        SelectList category_second_selectlist { get; set; }
        ...
        string status_stock { get; set; }
        SelectList status_stock_selectlist { get; set; }
        string status_condition { get; set; }
        SelectList status_condition_selectlist { get; set; }
                
        string description { get; set; }
        string description_limit { get; set; }
        string note { get; set; }
        bool active { get; set; }
